...
If you have questions about how to use UCPeer, please read the
[UCPeer documentation][documentation] or ask on [Stack Overflow][stackoverflow].
...
- Stability is important. UCPeer is used by thousands of other libraries and features that require
...
- Check that new and updated code follows UCPeer's existing code formatting and naming standard
- Run UCPeer's unit tests to ensure no existing functionality has been affected
...
By contributing your code to UCPeer you grant Andre Trollip a non-exclusive, irrevocable, worldwide,
...
[github]: https://github.com/urbancoderza/ucsimplesocket
[documentation]: https://github.com/urbancoderza/ucsimplesocket/tree/master/UCPeer/Documentation
